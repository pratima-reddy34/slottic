...
import { doc, setDoc, getDoc, serverTimestamp, updateDoc, query, collection, where, limit, getDocs as getFirestoreDocs } from "firebase/firestore";
...
import { ArrowLeft, Loader2, PlusCircle, Trash2, Image as ImageIcon, CalendarDays, MapPinIcon, UsersIcon, WifiIcon, CoffeeIcon, MicIcon, SpeakerIcon, ProjectorIcon, Clock } from "lucide-react";
